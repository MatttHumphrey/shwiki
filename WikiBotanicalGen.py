...
def main(name,filename):
    ...
    with open(output_file, "w+", encoding="utf8") as output:
        ...
        output.writelines("'''"+plant_name+"''' is one of the plants that can be earned from the [[File:SaveThePlantIcon.png|21x21px]] [[Flower Garden (Board)#Save the Plant|Save the Plant]] event. A level 12 plant can be placed in the [[Botanical Garden]]. It was available from "+start_date+" to "+end_date+".\n\n")
        output.writelines("It can be earned from [[File:"+filename+"SeedBox03.png|21x21px]][[Plant Seed Boxes#"+plant_name+" Seed Box|Plant Seed Boxes]] and [[File:"+filename+"RareSeedBox01.png|21x21px]][[Plant Seed Boxes#"+plant_name+" Seed Box|Rare Plant Seed Boxes]].\n\n")
        output.writelines("'''Note:''' Due to the game's constant updates, the information displayed on this page may not always be up to date. If you have any new information, feel free to edit accordingly.\n\n")
        output.writelines("==Story==\n<div class=\"mw-collapsible mw-collapsed\">\nClick '''Expand''' to view dialogue\n<div class=\"mw-collapsible-content\">\n{{/Dialogue}}\n</div>\n</div>\n\n")
        ...
        output.writelines("===Double Bubbles===\n{| class=\"article-table\"\n|+\n"+plant_name+": Double Bubbles**\n!Lvl\n!Image\n! Item\n![[Double Bubble]] Cost\n")
        for i in sorted(list(cost.keys())):
            if bubble_gem[i] != 0:
