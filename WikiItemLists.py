...
def get_arealist():
    output_file = "C:\\Users\\Matth\\Documents\\DataExtr\\Working_Code\\area_output.txt"
    area_list = []
...
def get_game_items():
    item_totals = {}
    output_file = "C:\\Users\\Matth\\Documents\\DataExtr\\Working_Code\\game_items_output.txt"
    with open(gde_file, "r", encoding="utf8") as file:
        data = json.load(file)
        for line in data:
            if data[line].get("1070") == "Quest":
...
def get_area_items():
    output_file = "C:\\Users\\Matth\\Documents\\DataExtr\\Working_Code\\area_items_output.txt"
    area_file = "C:\\Users\\Matth\\Documents\\DataExtr\\Working_Code\\area_output.txt"
...
def get_hard_items():
    output_file = "C:\\Users\\Matth\\Documents\\DataExtr\\Working_Code\\hard_items_output.txt"
    area_file = "C:\\Users\\Matth\\Documents\\DataExtr\\Working_Code\\area_output.txt"
...
def custom_hard_items(area):
    output_file = "C:\\Users\\Matth\\Documents\\DataExtr\\Working_Code\\custom_hard_items_output.txt"
    area_file = "C:\\Users\\Matth\\Documents\\DataExtr\\Working_Code\\"+area
    with open(gde_file, "r", encoding="utf8") as file, open(area_file, "r", encoding="utf8") as areas, open(output_file, "w", encoding="utf8") as output:
        data = json.load(file)
        area_total = {}
        for place in areas:
...
custom_hard_items("matt_areas.txt")